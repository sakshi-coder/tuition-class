...
<body>
<form method="get"action="http://192.168.100.252/ty10/project/tpage.php">
<div class="navbar">
...
$a=pg_query("select * from studentt;");

        echo "<br><table border=2>";
                echo "<tr><td>SR no.</td><td>Student Name</td><td> class</td><td>phone no</td><td>address</td><td>gender</td><td>DOB</td><td>email</td><td>school</td><td>board</td><td>windup time</td><td>schedule</td></tr>";
        if(!$a)
		{
        ...
        {
	    echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td>".$r[2]."</td><td>".$r[3]."</td><td>".$r[4]."</td><td>".$r[5]."</td><td>".$r[6]."</td><td>".$r[7]."</td><td>".$r[8]."</td><td>".$r[9]."</td><td>".$r[10]."</td><td>".$r[11]."</td></tr>";
		}
        }
        echo "</table>";
?>
