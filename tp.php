...
$a=pg_query("select tid,tname,class,email,board,shname from tutor;");

        echo "<br><table border=2>";
                echo "<tr><td>SR no.</td><td>tutor Name</td><td> class</td><td>email</td><td>board</td><td>batch</td></tr>";
        if(!$a)
		{
