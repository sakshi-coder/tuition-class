...
$s=pg_query("select * from feedback;");
echo"<table border=1>";
...
echo"</table>";
?>
<button type="submit" style="font-size:25px;width:30%;"><a href="http://192.168.100.252/ty10/project/d.html">delete record</a></button>
<br>
