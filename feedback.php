...
<body>
<form method="GET" action="http://192.168.100.252/ty10/project/f.php">
<div class="navbar">
  <li style="float:left"><a>@Excel Classes</a></li>
  
 <a href="http://192.168.100.252/ty10/project/contactus.html">Contact us</a>
  <a href="http://192.168.100.252/ty10/project/f1.html">Feedback</a>
  ...
  <a href="http://192.168.100.252/ty10/project/faculty.html">Faculty</a>
  <div class="dropdown">
...
<div class="bg-image" ><img src="http://192.168.100.252/ty10/project/101.jfif" width="1400" height="750">
<div class="bg-text">
<h2>Feedback</h2>
<hr>
  <div class="container">
...
<br>
    ...
    <input type="text" placeholder="Enter comment" name="c" required>
    <br>    
	<hr>
...
$a=mysql_query("select * from feedback;");
echo"<table border=1>";
	echo "<tr><td>id</td><td>name</td><td>email</td><td>feedback</td></tr>";
