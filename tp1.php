...
$a=pg_query("select tid,tname,gender,contact_no,addr,dob,email,exp,quali,class,available_time,board,shid from tutor;");

        echo "<br><table border=2>";
                echo "<tr><td>SR no.</td><td>tutor Name</td><td> gender</td><td>conatct no</td><td>address</td><td>dob</td><td>email</td><td>exp</td><td>qualification</td><td>class</td><td>available time</td><td>board</td><td>schedule</td></tr>";
        if(!$a)
		{
		echo "<br>select not done";
		}
		else
		{
		while($r=pg_fetch_row($a))
        {
	    echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td>".$r[2]."</td><td>".$r[3]."</td><td>".$r[4]."</td><td>".$r[5]."</td><td>".$r[6]."</td><td>".$r[7]."</td><td>".$r[8]."</td><td>".$r[9]."</td><td>".$r[10]."</td><td>".$r[11]."</td><td>".$r[12]."</td></tr>";
		}
        }
        echo "</table>";
?>
