...
<body>
<form method="get"action="http://192.168.100.252/ty10/project/spage.php">
<div class="navbar">
...
$x=$_COOKIE["e"];
echo$x;
$a=pg_query("select * from test where student_name='$x';");
if(!$a)
{
	echo"test not given";
}
else
{
	echo"test given";
	echo"<table border=1>";
	echo"<tr><td>srno</td><td>test name </td><td>student name</td><td>class</td><td>board</td><td>batch</td><td>subject</td><td>chapter</td><td>marks</td></tr>";
